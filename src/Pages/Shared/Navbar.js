            ...
            <div class="navbar-start">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-compact text-white dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li className='bg-[#00227b] rounded px-6 mr-2 mt-1'><Link to='/'>TASK</Link></li>
                        <li className='bg-[#00227b] rounded px-6 mr-2 mt-1'><Link to='/Add-Task'>TO-DO</Link></li>
                        <li className='bg-[#00227b] rounded px-6 mr-2 mt-1'><Link to='/calendar'>CALENDER</Link></li>
                        <li className='bg-[#00227b] rounded px-0 mt-1'><a>COMPLETED TASKS</a></li>
                    </ul>
                </div>
